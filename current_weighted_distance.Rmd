...
medits_add=c("833955fffffffff","833f32fffffffff","832db5fffffffff")
...
currents_used=read_rds("currents_used.rds")
```
...
dci_data_step_3 <- dci_data %>%
  ...
  mutate(
    ...
    Dx = sin(bearing_rad), # East-West component of the Dispersal path = 1 = complete east and -1 is full west component
    Dy = cos(bearing_rad), # North-South component of the Dispersal path = 1 = complete north, and -1 is full south component.
