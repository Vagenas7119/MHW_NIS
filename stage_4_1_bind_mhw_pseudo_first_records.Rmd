...
test_sp_dt_time_sst_mon_eff=read_rds("glmms\\test_sp_dt_time_sst_mon_eff\\test_sp_dt_time_sst_mon_eff.rds")
...
test_sp_dt_time_sst_mon_eff_r2
...
#Source
test_sp_dt_time_sst_mon_eff_dcip_p=ggplot(filtered_data_before_first_record_dt_sst_meff)+
  geom_point(aes(x=DCI_P,y=records),
             alpha=0.3,
             color="grey")+
  geom_ribbon(data=test_sp_dt_time_sst_mon_eff_gg_dcip,
              aes(x=x,ymin=conf.low,ymax=conf.high),
              alpha=0.3,
              fill="#E61316")+
  geom_line(data=test_sp_dt_time_sst_mon_eff_gg_dcip,
              aes(x=x,y=predicted),
            linewidth=1)+
  labs(x="DCIp (m/s)",
       y="Probability of record occurrence",
       title="B) Distance-penalized Directional Current Index")+
  theme_bw()+
  theme(axis.title.y = element_blank())
test_sp_dt_time_sst_mon_eff_dcip_p
