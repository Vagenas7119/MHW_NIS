...
######################################################################
#Now keep only mhe data preexcisting to the species record in h3_id
...
```{r}
test_sp_dt_time_sst_mon_eff_grid=gridExtra::grid.arrange(
  test_sp_dt_time_sst_mon_eff_yr_p,
                        test_sp_dt_time_sst_mon_eff_sst_p,
                        test_sp_dt_time_sst_mon_eff_cint_p,
                        ncol = 2,
...
ggsave(filename ="test_sp_dt_time_sst_mon_eff_grid.png" ,plot =test_sp_dt_time_sst_mon_eff_grid ,device = "jpeg",units = "cm",width = 20,height = 14)
```
