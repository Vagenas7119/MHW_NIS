...
h3_map <- ggplot() +
  ...
  geom_sf(data = world, fill = "#B8D380", color = "black", linewidth = 0.1) +
...
bias_grid=gridExtra::grid.arrange(
  ...
  layout_matrix = rbind(c(1, 1,1,1,1),
                        c(1, 1,1,1,1),
                        c(1, 1,1,1,1),# Row 1: P1 and P2
                        c(NA,2,2,2,NA),
                        c(NA,2,2,2,NA)))

bias_grid
ggsave(filename ="bias_grid.png" ,plot =bias_grid ,device = "jpeg",units = "cm",width = 20,height = 15)
```
