...
write_rds(medits_mhw_fbl,"medits_mhw_fbl.rds")
```
...
#add MHWs to medits
medits_mhw_n_fbl=medits_cleaned_abundance %>% 
  left_join(mhws_annual_fbl %>% 
              select(h3_id,
                     year_of_mhw=year_of_mhws,
                     annual_c_int),
...
#write_rds(medits_mhw_n_fbl,"medits_mhw_n_fbl.rds")
```
#Detrended
Biomass
```{r}
