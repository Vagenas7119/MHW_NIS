...
test_1=glmmTMB(data=medits_biotime_mhw_dt_nis,
        formula = log_n_ratio~ scale(DCI_P)+scale(year_of_mhw)+scale(annual_c_int)+scale(median_sst)+(1|country),
        family = "tweedie",
        weights =log_n_pop,
...
test_3=glmmTMB(data=medits_biotime_mhw_dt_nis,
        formula = ratios~scale(DCI_P)+scale(year_of_mhw)+scale(median_sst)+scale(annual_c_int)+(1|country),
        weights =log_n_pop, 
