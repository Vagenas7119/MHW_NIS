...
species_df_harmo=Harmonization_fix %>% 
  select(species=corrected) %>% 
  left_join(nis_harmo,by="species") %>% 
  mutate(lessepsian=case_when(species%in%"Centrophorus granulosus"~0,
                              species%in%"Coelorinchus occa"~0,
                              species%in%"Gaidropsarus biscayensis"~0,
                              species%in%"Molva dypterygia"~0,
                              species%in%"Stomias boa boa"~0,
                              species%in%"Trachyscorpia cristulata echinata"~0,
                              species%in%"Trisopterus capelanus"~0,
                              species%in%"Trachyscorpia cristulata echinata"~0,
                              species%in%"Salmo trutta trutta"~0,
                              species%in%"Arnoglossus kessleri"~0,
                              TRUE~lessepsian)) %>% 
  distinct(species,lessepsian)
