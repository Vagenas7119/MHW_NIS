...
analysis_h3=read_rds("filtered_data_before_first_record_dt_sst_meff.rds")$h3_id %>% unique
medits_add=c("833955fffffffff","833f32fffffffff","832db5fffffffff") # add medits biotime related hex
h3_filter=c(medits_add,analysis_h3)

currents_used=currents %>% 
  filter(h3_id%in%h3_filter)

#write_rds(currents,"currents.rds")
#write_rds(currents_used,"currents_used.rds")
getwd()
currents_used=read_rds("copernicus_data_by_hexagon/currents/currents_used.rds")
```
...
print(direction_map)
# ggsave(filename ="direction_map.png" ,plot =direction_map ,device = "jpeg",units = "cm",width = 20,height = 12)
...
ggsave(filename ="component_B_propagation_map.png" ,plot =component_B_propagation_map ,device = "jpeg",units = "cm",width = 20,height = 12)
```
...
ggsave(filename ="component_B_propagation_map_dd.png" ,plot =cpi_map ,device = "jpeg",units = "cm",width = 20,height = 12)

write.csv(cpi_data_with_C,"cpi_data_with_C.csv",row.names = F)
