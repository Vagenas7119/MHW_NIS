...
```{r}
test=read_rds("copernicus_data_by_hexagon/MEDSEA_MULTIYEAR_PHY_006_004/831e82fffffffff.rds") %>% drop_na()
...
ggplot(test_mean)+
  geom_point(aes(x=date,y=mean_sst))
```
...
input_dir <- "copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004"
output_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\"
...
```{r}
# 1. Define the input and output directories
input_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\"
output_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\h3_hex_plots\\"
...
# 1. Define the input and output directories
input_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\"
output_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\sst_trends\\"
...
mean_sst_df <- data %>%
  ...
  p <- ggplot(data = mean_sst_df, aes(x = date, y = mean_sst)) +
...
input_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\"
output_dir <- "C:\\Users\\User\\Desktop\\research\\Mentoring and colaborations\\Georgous\\MHW_NIS\\copernicus_data_by_hexagon\\MEDSEA_MULTIYEAR_PHY_006_004\\corrected_hex_level_data\\final_data\\"
...
output_file_path <- file.path(output_dir, "all_hexagons_daily_summary.rds")
